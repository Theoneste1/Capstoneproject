...
def main():
    ...
    if choice == "Home":
        st.subheader("Home")
        st.write("Note please: This is a platform that will the people who are not familiar with writing the codes to do machine learning by using their choosen model")
        ...
        if st.sidebar.checkbox("Login"):
            ...
            if result:
                ...
                task = st.selectbox("Task",["Analysis","Analytics","Profiles"])
                if task == "Analysis":
